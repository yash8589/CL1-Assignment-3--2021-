...
if (inp == "verb" or inp == "Verb"):
    ...
    if (wrd[-1] == "e" and wrd[-2] != "i" and wrd != "leave"):      # dance, mince, bake
        print(wrd)
        print(wrd+"s")
        print(wrd[:-1]+"ed")
        print(wrd[:-1]+"ed")
        print(wrd[:-1]+"ing")
    elif (wrd[-1] == "y" and wrd != "play" and wrd != "slay"):      # marry, carry, cry
        print(wrd)
        print(wrd[:-1]+"ies")
        print(wrd[:-1]+"ied")
        print(wrd[:-1]+"ied")
    ...
    print("")
    print("Word forms:")
    if (wrd[-1] == "s" or (wrd[-1] == "h" and wrd[-2] == "c") or (wrd[-1] == "h" and wrd[-2] == "s") or wrd[-1] == "x" or wrd[-1] == "z" ):         # branch, dish, Quiz
        print(wrd)
        print(wrd+"es")
        ...
        print(wrd)
        print(wrd[:-2]+"ves")
    elif (wrd[-1]=="y" and (wrd[-2] == "a" or wrd[-2] == "e" or wrd[-2] == "i" or wrd[-2] == "o" or wrd[-2] == "u")):                               # annoy, toy, boy
        print(wrd)
        print(wrd+"s")
